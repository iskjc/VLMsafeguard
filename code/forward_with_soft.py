...
def main():
    ...
    target_device = model.get_input_embeddings().weight.device if is_llava else model.device
    model.set_input_embeddings(new_input_embeddings.to(device=target_device, dtype=model.dtype))
